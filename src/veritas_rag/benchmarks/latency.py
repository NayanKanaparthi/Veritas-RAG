...
def run_latency_benchmarks(
    artifact_path: str, query: str = "test query", report_json_path: Optional[str] = None
) -> Dict:
    """
    ...
    result = {
        ...
        "artifact": artifact_stats,  # Use "artifact" key to match CLI expectations
        "artifact_stats": artifact_stats,  # Keep for backward compatibility
    }
    ...
    if report_json_path:
        metrics = {
            "cold_start_ms": cold_start_time,
            "retrieval_only_p50": retrieval_latency["p50"],
            "retrieval_only_p95": retrieval_latency["p95"],
            "retrieval_fetch_p50": retrieval_fetch_latency["p50"],
            "retrieval_fetch_p95": retrieval_fetch_latency["p95"],
        }
        write_json_report(
